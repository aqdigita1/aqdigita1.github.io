...
<link rel="stylesheet" id="install-css" href="/wp-admin/css/install.min.css?ver=6.4.3" media="all">
</head>
<body class="wp-core-ui">
<p id="logo">WordPress</p>

	<h1>Already Installed</h1><p>You appear to have already installed WordPress. To reinstall please clear your old database tables first.</p><p class="step"><a href="/wp-login.php">Log In</a></p></body></html>